  ...
  return (
    <div className="highlights">
      ...
      <p className="highlights__subtitle">
        What's new? Discover popular games, new releases and outstanding bargains!
      </p>
      <div className="highlights__tabs">
        <button className="highlights__tab highlights__tab--active">Popular</button>
        <button className="highlights__tab">New Releases</button>
        <button className="highlights__tab">Offers</button>
      </div>
